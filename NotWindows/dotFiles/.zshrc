...
alias rustscan='sudo docker run -it --rm --name rustscan --network host --ulimit nofile=100000:100000 --privileged -v /dev:/dev -v $HOME/.rustscan:/home/rustscan:ro rustscan/rustscan:2.1.1'
