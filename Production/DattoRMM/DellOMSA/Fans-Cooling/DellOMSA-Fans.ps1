...
$Global:AlertHealthy = "$Global:totalFans Fans Fully Operational | Last Checked $Date" # Define what should be displayed in Datto when monitor is healthy and $Global:AlertMsg is blank.
