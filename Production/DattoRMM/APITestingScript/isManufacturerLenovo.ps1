...
# Check for Lenovo, install Lenovo System Update
...
# Script Name
$ScriptName = "Check if Manufacturer is Lenovo"
...
$Global:DiagMsg += "Checking Computer Manufacturer..."

if ($System.Manufacturer -match "Lenovo") {
    $Global:DiagMsg += "Computer reported Manufacturer as " + $System.Manufacturer + " " + $System.Model
    $Global:DiagMsg += "Computer is a Lenovo."
    $Global:AlertMsg += "Computer is a Lenovo!"
}
else {
    $Global:DiagMsg += "Computer reported Manufacturer as " + $System.Manufacturer + " " + $System.Model
    $Global:DiagMsg += "Computer is not a Lenovo"
}
...
if ($Global:AlertMsg) {
    ...
    write-DRMMAlert "Reported as Lenovo $Global:AlertHealthy"
    write-DRMMDiag $Global:DiagMsg
