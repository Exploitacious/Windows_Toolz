...
# corruptBootloader (Checkbox): A 'more permanent' disablement of a computer. Significatly harder to recover, especially when combined with Bitlocker TPM wipe. Default: false.
