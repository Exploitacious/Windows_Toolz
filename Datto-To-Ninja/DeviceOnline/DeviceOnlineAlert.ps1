...
$ScriptName = "Device Online Alert" # Quick and easy name of Script to help identify
$ScriptType = "Monitoring" # Monitoring // Remediation
$Date = get-date -Format "MM/dd/yyy hh:mm tt"

# What to Write if Alert is Healthy
$Global:AlertHealthy = "This monitor should always be in an alert state." # Define what should be displayed in Datto when monitor is healthy and $Global:AlertMsg is blank.
...
$Global:AlertMsg += "DEVICE IS ONLINE: $hostname reported online at $Date."
$Global:DiagMsg += "Intentionally triggering alert to confirm device connectivity."
